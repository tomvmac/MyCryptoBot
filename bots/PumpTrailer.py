...
# Strategy Name: Pump Trailer
# General Strategy:
# Pump Trailer will look at the historical prices from yesterday and the past 4 hours to determine if there is pump.  If there is a pump, we look for a recent

# Buy Signal:
# 1. Buy when there is a pump within 24 hours (AND)
# 2. Downtrending
# 3. Buy limit order at a lower than current price by a threshold
